		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "EMTS Trade Test Tool",
									"targetURL": "#zcomemtstradetesttool-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcomemtstradetesttool-display": {
								"semanticObject": "zcomemtstradetesttool",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcomemtstradetesttool",
									"url": sap.ui.require.toUrl("zcomemtstradetesttool")
								}
							}
						}
					}
